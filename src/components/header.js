  ...
  render() {
    return (
      <header className="main-header">
        {/* Logo */}
        <a href="http://www.planoinvestimentos.com" className="logo">
          {/* mini logo for sidebar mini 50x50 pixels */}
          <span className="logo-mini"><b>Plano</b>Investimentos</span>
          {/* logo for regular state and mobile devices */}
          <span className="logo-lg"><b>Plano</b>Investimentos</span>
        </a>
        {/* Header Navbar */}
